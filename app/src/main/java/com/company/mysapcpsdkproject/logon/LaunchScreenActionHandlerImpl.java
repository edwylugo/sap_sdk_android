...
public class LaunchScreenActionHandlerImpl extends WelcomeScreenActionHandlerImpl implements ActivityResultActionHandler {
    ...
    private boolean authenticateWithServer(Fragment fragment) {
        ...
        try {
            ...
            if (token != null) {
                ...
                registerForPush(sapWizardApplication, activity);
            } else {
    ...
    private void registerForPush(SAPWizardApplication sapWizardApplication, Activity activity) {
        String fcmToken = FirebaseInstanceId.getInstance().getToken();
        if (fcmToken != null) {
            PushNotificationUtilities pushNotificationUtilities = new PushNotificationUtilities(activity, sapWizardApplication.getErrorHandler(), sapWizardApplication.getSettingsParameters());
            pushNotificationUtilities.sendRegistrationToServer(fcmToken);
        } else {
            // no token - no push
