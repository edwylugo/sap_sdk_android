...
import com.company.mysapcpsdkproject.archcomp.SingleLiveEvent;

import com.company.mysapcpsdkproject.repository.OperationResult.Operation;
...
public class Repository<T extends EntityValue> {
     ...
     * @param ipmContainer - OData service
     * @param entitySet - the entity set this repository provides access for
     */
    public Repository(@NonNull ipmContainer ipmContainer, @NonNull EntitySet entitySet, @Nullable Property orderByProperty) {
        this.ipmContainer = ipmContainer;
    ...
    public void read() {
        ...
        ipmContainer.executeQueryAsync(dataQuery,
            result -> {
    ...
    public void read(EntityValue parent, String navigationPropertyName) {
        ...
        ipmContainer.loadPropertyAsync(navigationProperty, parent, dataQuery,
            () -> {
    ...
    public void create(@NonNull T newEntity, @NonNull StreamBase media) {
        if (newEntity.getEntityType().isMedia()) {
            ipmContainer.createMediaAsync(newEntity, media,
                () -> {
    ...
    public void create(@NonNull T newEntity) {
        ...
        ipmContainer.createEntityAsync(newEntity,
            () -> {
                insertToCache(newEntity, entities);
                if (relatedEntities.size() > 0) {
                    insertToCache(newEntity, relatedEntities);
    ...
    public void update(@NonNull T updateEntity) {
        ipmContainer.updateEntityAsync(updateEntity,
            () -> {
    ...
    public void delete(@NonNull List<T> deleteEntities) {
        ...
        ipmContainer.applyChangesAsync(deleteChangeSet,
            () -> {
    ...
    public void downloadMedia(@NonNull T entity, Action1<byte[]> successHandler,
        ...
        ipmContainer.downloadMediaAsync(entity,
