...
import com.company.mysapcpsdkproject.databinding.FragmentUsersDetailBinding;
 ...
 * This fragment is contained in an UsersActivity.
 */
public class UsersDetailFragment extends InterfacedFragment<User> {

    /** Generated data binding class based on layout file */
    private FragmentUsersDetailBinding binding;

    /** User entity to be displayed */
    ...
    public void onNavigationClickedToEnrollOrderTypes_EnrollOrderTypeDetails(View v) {
        Intent intent = new Intent(this.currentActivity, EnrollOrderTypesActivity.class);
        intent.putExtra("parent", userEntity);
        intent.putExtra("navigation", "EnrollOrderTypeDetails");
    ...
    private void onDeleteComplete(@NonNull OperationResult<User> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, userEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull User userEntity) {
        viewModel.downloadMedia(userEntity, media -> {
            ...
            if (userEntity.getDataValue(User.activityType) != null && !userEntity.getDataValue(User.activityType).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(userEntity.getDataValue(User.activityType).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of User
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(userEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(userEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(userEntity));
            ...
            setDetailImage(objectHeader, userEntity);
