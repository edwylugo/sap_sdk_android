 ...
 * - {@link OrderRuleTypesCreateFragment}: to create or edit a(n) OrderRuleType,
 * - {@link OrderRuleTypesDetailFragment}: to display the details of a(n) OrderRuleType,
 * - {@link OrderRuleTypesListFragment}: to list OrderRuleTypes.
 *
 ...
 * what to do.
 */
public class OrderRuleTypesActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<OrderRuleType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link OrderRuleTypesListFragment} is
     * getting instantiated (which will load {@link OrderRuleTypesDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderRuleTypesListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable OrderRuleType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        OrderRuleTypesCreateFragment fragment = new OrderRuleTypesCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable OrderRuleType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderRuleTypesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new OrderRuleTypesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable OrderRuleType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link OrderRuleTypesCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((OrderRuleTypesActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            OrderRuleTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(OrderRuleTypeViewModel.class);
