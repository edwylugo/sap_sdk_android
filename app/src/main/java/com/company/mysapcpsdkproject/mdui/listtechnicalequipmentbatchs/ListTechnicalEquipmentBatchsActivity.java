 ...
 * - {@link ListTechnicalEquipmentBatchsCreateFragment}: to create or edit a(n) ListTechnicalEquipmentBatch,
 * - {@link ListTechnicalEquipmentBatchsDetailFragment}: to display the details of a(n) ListTechnicalEquipmentBatch,
 * - {@link ListTechnicalEquipmentBatchsListFragment}: to list ListTechnicalEquipmentBatchs.
 *
 ...
 * what to do.
 */
public class ListTechnicalEquipmentBatchsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ListTechnicalEquipmentBatch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ListTechnicalEquipmentBatchsListFragment} is
     * getting instantiated (which will load {@link ListTechnicalEquipmentBatchsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ListTechnicalEquipmentBatchsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ListTechnicalEquipmentBatch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ListTechnicalEquipmentBatchsCreateFragment fragment = new ListTechnicalEquipmentBatchsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ListTechnicalEquipmentBatch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ListTechnicalEquipmentBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ListTechnicalEquipmentBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ListTechnicalEquipmentBatch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ListTechnicalEquipmentBatchsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ListTechnicalEquipmentBatchsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ListTechnicalEquipmentBatchViewModel viewModel = ViewModelProviders.of(getActivity()).get(ListTechnicalEquipmentBatchViewModel.class);
