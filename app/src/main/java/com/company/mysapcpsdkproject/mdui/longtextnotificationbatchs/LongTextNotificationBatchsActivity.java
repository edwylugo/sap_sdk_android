 ...
 * - {@link LongTextNotificationBatchsCreateFragment}: to create or edit a(n) LongTextNotificationBatch,
 * - {@link LongTextNotificationBatchsDetailFragment}: to display the details of a(n) LongTextNotificationBatch,
 * - {@link LongTextNotificationBatchsListFragment}: to list LongTextNotificationBatchs.
 *
 ...
 * what to do.
 */
public class LongTextNotificationBatchsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<LongTextNotificationBatch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link LongTextNotificationBatchsListFragment} is
     * getting instantiated (which will load {@link LongTextNotificationBatchsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextNotificationBatchsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable LongTextNotificationBatch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        LongTextNotificationBatchsCreateFragment fragment = new LongTextNotificationBatchsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable LongTextNotificationBatch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextNotificationBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new LongTextNotificationBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable LongTextNotificationBatch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link LongTextNotificationBatchsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((LongTextNotificationBatchsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            LongTextNotificationBatchViewModel viewModel = ViewModelProviders.of(getActivity()).get(LongTextNotificationBatchViewModel.class);
