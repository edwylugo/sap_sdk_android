 ...
 * - {@link WorkCentersCreateFragment}: to create or edit a(n) WorkCenter,
 * - {@link WorkCentersDetailFragment}: to display the details of a(n) WorkCenter,
 * - {@link WorkCentersListFragment}: to list WorkCenters.
 *
 ...
 * what to do.
 */
public class WorkCentersActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<WorkCenter> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link WorkCentersListFragment} is
     * getting instantiated (which will load {@link WorkCentersDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new WorkCentersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable WorkCenter entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        WorkCentersCreateFragment fragment = new WorkCentersCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable WorkCenter entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new WorkCentersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new WorkCentersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable WorkCenter entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link WorkCentersCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((WorkCentersActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            WorkCenterViewModel viewModel = ViewModelProviders.of(getActivity()).get(WorkCenterViewModel.class);
