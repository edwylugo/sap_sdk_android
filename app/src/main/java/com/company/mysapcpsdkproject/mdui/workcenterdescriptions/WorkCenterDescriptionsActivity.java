 ...
 * - {@link WorkCenterDescriptionsCreateFragment}: to create or edit a(n) WorkCenterDescription,
 * - {@link WorkCenterDescriptionsDetailFragment}: to display the details of a(n) WorkCenterDescription,
 * - {@link WorkCenterDescriptionsListFragment}: to list WorkCenterDescriptions.
 *
 ...
 * what to do.
 */
public class WorkCenterDescriptionsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<WorkCenterDescription> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link WorkCenterDescriptionsListFragment} is
     * getting instantiated (which will load {@link WorkCenterDescriptionsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new WorkCenterDescriptionsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable WorkCenterDescription entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        WorkCenterDescriptionsCreateFragment fragment = new WorkCenterDescriptionsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable WorkCenterDescription entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new WorkCenterDescriptionsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new WorkCenterDescriptionsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable WorkCenterDescription entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link WorkCenterDescriptionsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((WorkCenterDescriptionsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            WorkCenterDescriptionViewModel viewModel = ViewModelProviders.of(getActivity()).get(WorkCenterDescriptionViewModel.class);
