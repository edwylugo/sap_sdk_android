 ...
 * - {@link ConfirmationsCreateFragment}: to create or edit a(n) Confirmation,
 * - {@link ConfirmationsDetailFragment}: to display the details of a(n) Confirmation,
 * - {@link ConfirmationsListFragment}: to list Confirmations.
 *
 ...
 * what to do.
 */
public class ConfirmationsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Confirmation> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ConfirmationsListFragment} is
     * getting instantiated (which will load {@link ConfirmationsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ConfirmationsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Confirmation entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ConfirmationsCreateFragment fragment = new ConfirmationsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Confirmation entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ConfirmationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ConfirmationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Confirmation entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ConfirmationsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ConfirmationsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ConfirmationViewModel viewModel = ViewModelProviders.of(getActivity()).get(ConfirmationViewModel.class);
