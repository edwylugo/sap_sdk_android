 ...
 * - {@link CombinationOrderActivitysCreateFragment}: to create or edit a(n) CombinationOrderActivity,
 * - {@link CombinationOrderActivitysDetailFragment}: to display the details of a(n) CombinationOrderActivity,
 * - {@link CombinationOrderActivitysListFragment}: to list CombinationOrderActivitys.
 *
 ...
 * what to do.
 */
public class CombinationOrderActivitysActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CombinationOrderActivity> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CombinationOrderActivitysListFragment} is
     * getting instantiated (which will load {@link CombinationOrderActivitysDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CombinationOrderActivitysListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable CombinationOrderActivity entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CombinationOrderActivitysCreateFragment fragment = new CombinationOrderActivitysCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CombinationOrderActivity entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CombinationOrderActivitysDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CombinationOrderActivitysDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CombinationOrderActivity entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CombinationOrderActivitysCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CombinationOrderActivitysActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CombinationOrderActivityViewModel viewModel = ViewModelProviders.of(getActivity()).get(CombinationOrderActivityViewModel.class);
