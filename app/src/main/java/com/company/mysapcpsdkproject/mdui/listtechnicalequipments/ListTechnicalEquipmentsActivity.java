 ...
 * - {@link ListTechnicalEquipmentsCreateFragment}: to create or edit a(n) ListTechnicalEquipment,
 * - {@link ListTechnicalEquipmentsDetailFragment}: to display the details of a(n) ListTechnicalEquipment,
 * - {@link ListTechnicalEquipmentsListFragment}: to list ListTechnicalEquipments.
 *
 ...
 * what to do.
 */
public class ListTechnicalEquipmentsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ListTechnicalEquipment> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ListTechnicalEquipmentsListFragment} is
     * getting instantiated (which will load {@link ListTechnicalEquipmentsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ListTechnicalEquipmentsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ListTechnicalEquipment entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ListTechnicalEquipmentsCreateFragment fragment = new ListTechnicalEquipmentsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ListTechnicalEquipment entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ListTechnicalEquipmentsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ListTechnicalEquipmentsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ListTechnicalEquipment entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ListTechnicalEquipmentsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ListTechnicalEquipmentsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ListTechnicalEquipmentViewModel viewModel = ViewModelProviders.of(getActivity()).get(ListTechnicalEquipmentViewModel.class);
