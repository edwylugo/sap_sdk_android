...
import com.company.mysapcpsdkproject.databinding.FragmentCauseofconfirmationsDetailBinding;
...
import com.sap.cloud.mobile.odata.EntityKey;
/**
 * A fragment representing a single CauseOfConfirmation detail screen.
 * This fragment is contained in an CauseOfConfirmationsActivity.
 */
public class CauseOfConfirmationsDetailFragment extends InterfacedFragment<CauseOfConfirmation> {

    /** Generated data binding class based on layout file */
    private FragmentCauseofconfirmationsDetailBinding binding;

    /** CauseOfConfirmation entity to be displayed */
    private CauseOfConfirmation causeOfConfirmationEntity = null;
    ...
    /** Arguments: CauseOfConfirmation for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            causeOfConfirmationEntity = entity;
            binding.setCauseOfConfirmation(entity);
            setupObjectHeader();
        });
    }
    ...
    private void onDeleteComplete(@NonNull OperationResult<CauseOfConfirmation> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, causeOfConfirmationEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull CauseOfConfirmation causeOfConfirmationEntity) {
        viewModel.downloadMedia(causeOfConfirmationEntity, media -> {
            ...
            if (causeOfConfirmationEntity.getDataValue(CauseOfConfirmation.describingReasonConfirmation) != null && !causeOfConfirmationEntity.getDataValue(CauseOfConfirmation.describingReasonConfirmation).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(causeOfConfirmationEntity.getDataValue(CauseOfConfirmation.describingReasonConfirmation).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of CauseOfConfirmation
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(causeOfConfirmationEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(causeOfConfirmationEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(causeOfConfirmationEntity));
            ...
            setDetailImage(objectHeader, causeOfConfirmationEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentCauseofconfirmationsDetailBinding.inflate(inflater, container, false);
