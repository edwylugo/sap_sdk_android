...
import com.company.mysapcpsdkproject.databinding.FragmentLocalinstallstructuresDetailBinding;
...
import com.sap.cloud.mobile.odata.EntityKey;
/**
 * A fragment representing a single LocalInstallStructure detail screen.
 * This fragment is contained in an LocalInstallStructuresActivity.
 */
public class LocalInstallStructuresDetailFragment extends InterfacedFragment<LocalInstallStructure> {

    /** Generated data binding class based on layout file */
    private FragmentLocalinstallstructuresDetailBinding binding;

    /** LocalInstallStructure entity to be displayed */
    private LocalInstallStructure localInstallStructureEntity = null;
    ...
    /** Arguments: LocalInstallStructure for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            localInstallStructureEntity = entity;
            binding.setLocalInstallStructure(entity);
            setupObjectHeader();
        });
    }
    ...
    private void onDeleteComplete(@NonNull OperationResult<LocalInstallStructure> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, localInstallStructureEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull LocalInstallStructure localInstallStructureEntity) {
        viewModel.downloadMedia(localInstallStructureEntity, media -> {
            ...
            if (localInstallStructureEntity.getDataValue(LocalInstallStructure.catalogProfile) != null && !localInstallStructureEntity.getDataValue(LocalInstallStructure.catalogProfile).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(localInstallStructureEntity.getDataValue(LocalInstallStructure.catalogProfile).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of LocalInstallStructure
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(localInstallStructureEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(localInstallStructureEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(localInstallStructureEntity));
            ...
            setDetailImage(objectHeader, localInstallStructureEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentLocalinstallstructuresDetailBinding.inflate(inflater, container, false);
