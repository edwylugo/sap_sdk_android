 ...
 * - {@link MaintenanceActivityTypesCreateFragment}: to create or edit a(n) MaintenanceActivityType,
 * - {@link MaintenanceActivityTypesDetailFragment}: to display the details of a(n) MaintenanceActivityType,
 * - {@link MaintenanceActivityTypesListFragment}: to list MaintenanceActivityTypes.
 *
 ...
 * what to do.
 */
public class MaintenanceActivityTypesActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceActivityType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceActivityTypesListFragment} is
     * getting instantiated (which will load {@link MaintenanceActivityTypesDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceActivityTypesListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceActivityType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceActivityTypesCreateFragment fragment = new MaintenanceActivityTypesCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceActivityType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceActivityTypesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceActivityTypesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceActivityType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceActivityTypesCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceActivityTypesActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceActivityTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceActivityTypeViewModel.class);
