 ...
 * - {@link ActionEventssCreateFragment}: to create or edit a(n) ActionEvents,
 * - {@link ActionEventssDetailFragment}: to display the details of a(n) ActionEvents,
 * - {@link ActionEventssListFragment}: to list ActionEventss.
 *
 ...
 * what to do.
 */
public class ActionEventssActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ActionEvents> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ActionEventssListFragment} is
     * getting instantiated (which will load {@link ActionEventssDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ActionEventssListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ActionEvents entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ActionEventssCreateFragment fragment = new ActionEventssCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ActionEvents entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ActionEventssDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ActionEventssDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ActionEvents entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ActionEventssCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ActionEventssActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ActionEventsViewModel viewModel = ViewModelProviders.of(getActivity()).get(ActionEventsViewModel.class);
