 ...
 * - {@link MaterialDescriptionsCreateFragment}: to create or edit a(n) MaterialDescription,
 * - {@link MaterialDescriptionsDetailFragment}: to display the details of a(n) MaterialDescription,
 * - {@link MaterialDescriptionsListFragment}: to list MaterialDescriptions.
 *
 ...
 * what to do.
 */
public class MaterialDescriptionsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaterialDescription> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaterialDescriptionsListFragment} is
     * getting instantiated (which will load {@link MaterialDescriptionsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaterialDescriptionsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaterialDescription entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaterialDescriptionsCreateFragment fragment = new MaterialDescriptionsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaterialDescription entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaterialDescriptionsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaterialDescriptionsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaterialDescription entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaterialDescriptionsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaterialDescriptionsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaterialDescriptionViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaterialDescriptionViewModel.class);
