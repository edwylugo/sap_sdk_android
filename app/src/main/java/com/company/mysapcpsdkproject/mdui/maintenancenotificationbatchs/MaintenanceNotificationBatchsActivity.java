 ...
 * - {@link MaintenanceNotificationBatchsCreateFragment}: to create or edit a(n) MaintenanceNotificationBatch,
 * - {@link MaintenanceNotificationBatchsDetailFragment}: to display the details of a(n) MaintenanceNotificationBatch,
 * - {@link MaintenanceNotificationBatchsListFragment}: to list MaintenanceNotificationBatchs.
 *
 ...
 * what to do.
 */
public class MaintenanceNotificationBatchsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceNotificationBatch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceNotificationBatchsListFragment} is
     * getting instantiated (which will load {@link MaintenanceNotificationBatchsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceNotificationBatchsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceNotificationBatch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceNotificationBatchsCreateFragment fragment = new MaintenanceNotificationBatchsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceNotificationBatch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceNotificationBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceNotificationBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceNotificationBatch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceNotificationBatchsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceNotificationBatchsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceNotificationBatchViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceNotificationBatchViewModel.class);
