 ...
 * - {@link OrderRuleTypeDataBatchsCreateFragment}: to create or edit a(n) OrderRuleTypeDataBatch,
 * - {@link OrderRuleTypeDataBatchsDetailFragment}: to display the details of a(n) OrderRuleTypeDataBatch,
 * - {@link OrderRuleTypeDataBatchsListFragment}: to list OrderRuleTypeDataBatchs.
 *
 ...
 * what to do.
 */
public class OrderRuleTypeDataBatchsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<OrderRuleTypeDataBatch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link OrderRuleTypeDataBatchsListFragment} is
     * getting instantiated (which will load {@link OrderRuleTypeDataBatchsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderRuleTypeDataBatchsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable OrderRuleTypeDataBatch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        OrderRuleTypeDataBatchsCreateFragment fragment = new OrderRuleTypeDataBatchsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable OrderRuleTypeDataBatch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderRuleTypeDataBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new OrderRuleTypeDataBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable OrderRuleTypeDataBatch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link OrderRuleTypeDataBatchsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((OrderRuleTypeDataBatchsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            OrderRuleTypeDataBatchViewModel viewModel = ViewModelProviders.of(getActivity()).get(OrderRuleTypeDataBatchViewModel.class);
