 ...
 * - {@link LongTextOrderBatchsCreateFragment}: to create or edit a(n) LongTextOrderBatch,
 * - {@link LongTextOrderBatchsDetailFragment}: to display the details of a(n) LongTextOrderBatch,
 * - {@link LongTextOrderBatchsListFragment}: to list LongTextOrderBatchs.
 *
 ...
 * what to do.
 */
public class LongTextOrderBatchsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<LongTextOrderBatch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link LongTextOrderBatchsListFragment} is
     * getting instantiated (which will load {@link LongTextOrderBatchsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextOrderBatchsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable LongTextOrderBatch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        LongTextOrderBatchsCreateFragment fragment = new LongTextOrderBatchsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable LongTextOrderBatch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextOrderBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new LongTextOrderBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable LongTextOrderBatch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link LongTextOrderBatchsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((LongTextOrderBatchsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            LongTextOrderBatchViewModel viewModel = ViewModelProviders.of(getActivity()).get(LongTextOrderBatchViewModel.class);
