 ...
 * - {@link EquipmentBatchssCreateFragment}: to create or edit a(n) EquipmentBatchs,
 * - {@link EquipmentBatchssDetailFragment}: to display the details of a(n) EquipmentBatchs,
 * - {@link EquipmentBatchssListFragment}: to list EquipmentBatchss.
 *
 ...
 * what to do.
 */
public class EquipmentBatchssActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<EquipmentBatchs> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link EquipmentBatchssListFragment} is
     * getting instantiated (which will load {@link EquipmentBatchssDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EquipmentBatchssListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable EquipmentBatchs entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        EquipmentBatchssCreateFragment fragment = new EquipmentBatchssCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable EquipmentBatchs entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EquipmentBatchssDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new EquipmentBatchssDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable EquipmentBatchs entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link EquipmentBatchssCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((EquipmentBatchssActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            EquipmentBatchsViewModel viewModel = ViewModelProviders.of(getActivity()).get(EquipmentBatchsViewModel.class);
