...
import com.company.mysapcpsdkproject.databinding.FragmentLongtextordersDetailBinding;
...
import com.sap.cloud.mobile.odata.EntityKey;
/**
 * A fragment representing a single LongTextOrder detail screen.
 * This fragment is contained in an LongTextOrdersActivity.
 */
public class LongTextOrdersDetailFragment extends InterfacedFragment<LongTextOrder> {

    /** Generated data binding class based on layout file */
    private FragmentLongtextordersDetailBinding binding;

    /** LongTextOrder entity to be displayed */
    private LongTextOrder longTextOrderEntity = null;
    ...
    /** Arguments: LongTextOrder for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            longTextOrderEntity = entity;
            binding.setLongTextOrder(entity);
            setupObjectHeader();
        });
    }
    ...
    private void onDeleteComplete(@NonNull OperationResult<LongTextOrder> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, longTextOrderEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull LongTextOrder longTextOrderEntity) {
        viewModel.downloadMedia(longTextOrderEntity, media -> {
            ...
            if (longTextOrderEntity.getDataValue(LongTextOrder.longText) != null && !longTextOrderEntity.getDataValue(LongTextOrder.longText).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(longTextOrderEntity.getDataValue(LongTextOrder.longText).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of LongTextOrder
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(longTextOrderEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(longTextOrderEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(longTextOrderEntity));
            ...
            setDetailImage(objectHeader, longTextOrderEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentLongtextordersDetailBinding.inflate(inflater, container, false);
