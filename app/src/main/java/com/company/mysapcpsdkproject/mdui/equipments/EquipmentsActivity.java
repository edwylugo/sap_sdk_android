 ...
 * - {@link EquipmentsCreateFragment}: to create or edit a(n) Equipment,
 * - {@link EquipmentsDetailFragment}: to display the details of a(n) Equipment,
 * - {@link EquipmentsListFragment}: to list Equipments.
 *
 ...
 * what to do.
 */
public class EquipmentsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Equipment> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link EquipmentsListFragment} is
     * getting instantiated (which will load {@link EquipmentsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EquipmentsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Equipment entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        EquipmentsCreateFragment fragment = new EquipmentsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Equipment entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EquipmentsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new EquipmentsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Equipment entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link EquipmentsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((EquipmentsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            EquipmentViewModel viewModel = ViewModelProviders.of(getActivity()).get(EquipmentViewModel.class);
