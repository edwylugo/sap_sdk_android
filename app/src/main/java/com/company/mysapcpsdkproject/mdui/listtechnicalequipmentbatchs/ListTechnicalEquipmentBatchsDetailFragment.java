...
import com.company.mysapcpsdkproject.databinding.FragmentListtechnicalequipmentbatchsDetailBinding;
...
/**
 * A fragment representing a single ListTechnicalEquipmentBatch detail screen.
 * This fragment is contained in an ListTechnicalEquipmentBatchsActivity.
 */
public class ListTechnicalEquipmentBatchsDetailFragment extends InterfacedFragment<ListTechnicalEquipmentBatch> {

    /** Generated data binding class based on layout file */
    private FragmentListtechnicalequipmentbatchsDetailBinding binding;

    /** ListTechnicalEquipmentBatch entity to be displayed */
    private ListTechnicalEquipmentBatch listTechnicalEquipmentBatchEntity = null;
    ...
    /** Arguments: ListTechnicalEquipmentBatch for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            listTechnicalEquipmentBatchEntity = entity;
            binding.setListTechnicalEquipmentBatch(entity);
            setupObjectHeader();
        });
    }
    ...
    public void onNavigationClickedToListTechnicalEquipments_ListTechnicalEquipmentDetails(View v) {
        ...
        intent.putExtra("parent", listTechnicalEquipmentBatchEntity);
    ...
    private void onDeleteComplete(@NonNull OperationResult<ListTechnicalEquipmentBatch> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, listTechnicalEquipmentBatchEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull ListTechnicalEquipmentBatch listTechnicalEquipmentBatchEntity) {
        viewModel.downloadMedia(listTechnicalEquipmentBatchEntity, media -> {
            ...
            if (listTechnicalEquipmentBatchEntity.getDataValue(ListTechnicalEquipmentBatch.id) != null && !listTechnicalEquipmentBatchEntity.getDataValue(ListTechnicalEquipmentBatch.id).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(listTechnicalEquipmentBatchEntity.getDataValue(ListTechnicalEquipmentBatch.id).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of ListTechnicalEquipmentBatch
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(listTechnicalEquipmentBatchEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(listTechnicalEquipmentBatchEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(listTechnicalEquipmentBatchEntity));
            ...
            setDetailImage(objectHeader, listTechnicalEquipmentBatchEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentListtechnicalequipmentbatchsDetailBinding.inflate(inflater, container, false);
