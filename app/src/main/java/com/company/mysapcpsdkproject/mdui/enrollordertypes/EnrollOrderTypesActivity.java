 ...
 * - {@link EnrollOrderTypesCreateFragment}: to create or edit a(n) EnrollOrderType,
 * - {@link EnrollOrderTypesDetailFragment}: to display the details of a(n) EnrollOrderType,
 * - {@link EnrollOrderTypesListFragment}: to list EnrollOrderTypes.
 *
 ...
 * what to do.
 */
public class EnrollOrderTypesActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<EnrollOrderType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link EnrollOrderTypesListFragment} is
     * getting instantiated (which will load {@link EnrollOrderTypesDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EnrollOrderTypesListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable EnrollOrderType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        EnrollOrderTypesCreateFragment fragment = new EnrollOrderTypesCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable EnrollOrderType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EnrollOrderTypesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new EnrollOrderTypesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable EnrollOrderType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link EnrollOrderTypesCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((EnrollOrderTypesActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            EnrollOrderTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(EnrollOrderTypeViewModel.class);
