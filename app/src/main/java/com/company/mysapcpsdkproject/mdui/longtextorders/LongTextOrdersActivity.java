 ...
 * - {@link LongTextOrdersCreateFragment}: to create or edit a(n) LongTextOrder,
 * - {@link LongTextOrdersDetailFragment}: to display the details of a(n) LongTextOrder,
 * - {@link LongTextOrdersListFragment}: to list LongTextOrders.
 *
 ...
 * what to do.
 */
public class LongTextOrdersActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<LongTextOrder> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link LongTextOrdersListFragment} is
     * getting instantiated (which will load {@link LongTextOrdersDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextOrdersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable LongTextOrder entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        LongTextOrdersCreateFragment fragment = new LongTextOrdersCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable LongTextOrder entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextOrdersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new LongTextOrdersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable LongTextOrder entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link LongTextOrdersCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((LongTextOrdersActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            LongTextOrderViewModel viewModel = ViewModelProviders.of(getActivity()).get(LongTextOrderViewModel.class);
