...
import com.company.mysapcpsdkproject.databinding.FragmentWorkcentersDetailBinding;
...
import com.sap.cloud.mobile.odata.EntityKey;
/**
 * A fragment representing a single WorkCenter detail screen.
 * This fragment is contained in an WorkCentersActivity.
 */
public class WorkCentersDetailFragment extends InterfacedFragment<WorkCenter> {

    /** Generated data binding class based on layout file */
    private FragmentWorkcentersDetailBinding binding;

    /** WorkCenter entity to be displayed */
    private WorkCenter workCenterEntity = null;
    ...
    /** Arguments: WorkCenter for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            workCenterEntity = entity;
            binding.setWorkCenter(entity);
            setupObjectHeader();
        });
    }
    ...
    private void onDeleteComplete(@NonNull OperationResult<WorkCenter> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, workCenterEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull WorkCenter workCenterEntity) {
        viewModel.downloadMedia(workCenterEntity, media -> {
            ...
            if (workCenterEntity.getDataValue(WorkCenter.languageKey) != null && !workCenterEntity.getDataValue(WorkCenter.languageKey).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(workCenterEntity.getDataValue(WorkCenter.languageKey).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of WorkCenter
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(workCenterEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(workCenterEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(workCenterEntity));
            ...
            setDetailImage(objectHeader, workCenterEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentWorkcentersDetailBinding.inflate(inflater, container, false);
