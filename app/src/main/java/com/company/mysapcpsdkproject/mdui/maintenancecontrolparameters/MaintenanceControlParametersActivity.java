 ...
 * - {@link MaintenanceControlParametersCreateFragment}: to create or edit a(n) MaintenanceControlParameter,
 * - {@link MaintenanceControlParametersDetailFragment}: to display the details of a(n) MaintenanceControlParameter,
 * - {@link MaintenanceControlParametersListFragment}: to list MaintenanceControlParameters.
 *
 ...
 * what to do.
 */
public class MaintenanceControlParametersActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceControlParameter> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceControlParametersListFragment} is
     * getting instantiated (which will load {@link MaintenanceControlParametersDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceControlParametersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceControlParameter entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceControlParametersCreateFragment fragment = new MaintenanceControlParametersCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceControlParameter entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceControlParametersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceControlParametersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceControlParameter entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceControlParametersCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceControlParametersActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceControlParameterViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceControlParameterViewModel.class);
