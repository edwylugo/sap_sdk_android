...
import com.company.mysapcpsdkproject.databinding.FragmentEmployeesDetailBinding;
 ...
 * This fragment is contained in an EmployeesActivity.
 */
public class EmployeesDetailFragment extends InterfacedFragment<Employee> {

    /** Generated data binding class based on layout file */
    private FragmentEmployeesDetailBinding binding;

    /** Employee entity to be displayed */
    private Employee employeeEntity = null;
    ...
    /** Arguments: Employee for display */
    @Override
    ...
    private void onDeleteComplete(@NonNull OperationResult<Employee> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, employeeEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull Employee employeeEntity) {
        viewModel.downloadMedia(employeeEntity, media -> {
            ...
            if (employeeEntity.getDataValue(Employee.endDate) != null && !employeeEntity.getDataValue(Employee.endDate).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(employeeEntity.getDataValue(Employee.endDate).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of Employee
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(employeeEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(employeeEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(employeeEntity));
            ...
            setDetailImage(objectHeader, employeeEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentEmployeesDetailBinding.inflate(inflater, container, false);
