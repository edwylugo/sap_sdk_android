 ...
 * - {@link InspectionCatalogCodeGroupsCreateFragment}: to create or edit a(n) InspectionCatalogCodeGroup,
 * - {@link InspectionCatalogCodeGroupsDetailFragment}: to display the details of a(n) InspectionCatalogCodeGroup,
 * - {@link InspectionCatalogCodeGroupsListFragment}: to list InspectionCatalogCodeGroups.
 *
 ...
 * what to do.
 */
public class InspectionCatalogCodeGroupsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<InspectionCatalogCodeGroup> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link InspectionCatalogCodeGroupsListFragment} is
     * getting instantiated (which will load {@link InspectionCatalogCodeGroupsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new InspectionCatalogCodeGroupsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable InspectionCatalogCodeGroup entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        InspectionCatalogCodeGroupsCreateFragment fragment = new InspectionCatalogCodeGroupsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable InspectionCatalogCodeGroup entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new InspectionCatalogCodeGroupsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new InspectionCatalogCodeGroupsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable InspectionCatalogCodeGroup entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link InspectionCatalogCodeGroupsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((InspectionCatalogCodeGroupsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            InspectionCatalogCodeGroupViewModel viewModel = ViewModelProviders.of(getActivity()).get(InspectionCatalogCodeGroupViewModel.class);
