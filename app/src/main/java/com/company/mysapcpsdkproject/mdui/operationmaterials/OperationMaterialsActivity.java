 ...
 * - {@link OperationMaterialsCreateFragment}: to create or edit a(n) OperationMaterial,
 * - {@link OperationMaterialsDetailFragment}: to display the details of a(n) OperationMaterial,
 * - {@link OperationMaterialsListFragment}: to list OperationMaterials.
 *
 ...
 * what to do.
 */
public class OperationMaterialsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<OperationMaterial> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link OperationMaterialsListFragment} is
     * getting instantiated (which will load {@link OperationMaterialsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OperationMaterialsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable OperationMaterial entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        OperationMaterialsCreateFragment fragment = new OperationMaterialsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable OperationMaterial entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OperationMaterialsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new OperationMaterialsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable OperationMaterial entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link OperationMaterialsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((OperationMaterialsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            OperationMaterialViewModel viewModel = ViewModelProviders.of(getActivity()).get(OperationMaterialViewModel.class);
