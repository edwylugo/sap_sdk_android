 ...
 * - {@link NotificationTypeTextsCreateFragment}: to create or edit a(n) NotificationTypeText,
 * - {@link NotificationTypeTextsDetailFragment}: to display the details of a(n) NotificationTypeText,
 * - {@link NotificationTypeTextsListFragment}: to list NotificationTypeTexts.
 *
 ...
 * what to do.
 */
public class NotificationTypeTextsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<NotificationTypeText> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link NotificationTypeTextsListFragment} is
     * getting instantiated (which will load {@link NotificationTypeTextsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationTypeTextsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable NotificationTypeText entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        NotificationTypeTextsCreateFragment fragment = new NotificationTypeTextsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable NotificationTypeText entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationTypeTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new NotificationTypeTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable NotificationTypeText entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link NotificationTypeTextsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((NotificationTypeTextsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            NotificationTypeTextViewModel viewModel = ViewModelProviders.of(getActivity()).get(NotificationTypeTextViewModel.class);
