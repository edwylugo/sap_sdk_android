 ...
 * - {@link MaintenanceOrderPriorityTextAssociationsCreateFragment}: to create or edit a(n) MaintenanceOrderPriorityTextAssociation,
 * - {@link MaintenanceOrderPriorityTextAssociationsDetailFragment}: to display the details of a(n) MaintenanceOrderPriorityTextAssociation,
 * - {@link MaintenanceOrderPriorityTextAssociationsListFragment}: to list MaintenanceOrderPriorityTextAssociations.
 *
 ...
 * what to do.
 */
public class MaintenanceOrderPriorityTextAssociationsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceOrderPriorityTextAssociation> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceOrderPriorityTextAssociationsListFragment} is
     * getting instantiated (which will load {@link MaintenanceOrderPriorityTextAssociationsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrderPriorityTextAssociationsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceOrderPriorityTextAssociation entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceOrderPriorityTextAssociationsCreateFragment fragment = new MaintenanceOrderPriorityTextAssociationsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceOrderPriorityTextAssociation entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrderPriorityTextAssociationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceOrderPriorityTextAssociationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceOrderPriorityTextAssociation entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceOrderPriorityTextAssociationsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceOrderPriorityTextAssociationsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceOrderPriorityTextAssociationViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceOrderPriorityTextAssociationViewModel.class);
