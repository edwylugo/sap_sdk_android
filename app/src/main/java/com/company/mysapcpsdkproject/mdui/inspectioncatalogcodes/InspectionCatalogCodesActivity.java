 ...
 * - {@link InspectionCatalogCodesCreateFragment}: to create or edit a(n) InspectionCatalogCode,
 * - {@link InspectionCatalogCodesDetailFragment}: to display the details of a(n) InspectionCatalogCode,
 * - {@link InspectionCatalogCodesListFragment}: to list InspectionCatalogCodes.
 *
 ...
 * what to do.
 */
public class InspectionCatalogCodesActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<InspectionCatalogCode> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link InspectionCatalogCodesListFragment} is
     * getting instantiated (which will load {@link InspectionCatalogCodesDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new InspectionCatalogCodesListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable InspectionCatalogCode entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        InspectionCatalogCodesCreateFragment fragment = new InspectionCatalogCodesCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable InspectionCatalogCode entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new InspectionCatalogCodesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new InspectionCatalogCodesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable InspectionCatalogCode entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link InspectionCatalogCodesCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((InspectionCatalogCodesActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            InspectionCatalogCodeViewModel viewModel = ViewModelProviders.of(getActivity()).get(InspectionCatalogCodeViewModel.class);
