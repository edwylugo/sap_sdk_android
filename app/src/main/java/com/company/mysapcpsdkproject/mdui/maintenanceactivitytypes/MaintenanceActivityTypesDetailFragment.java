...
import com.company.mysapcpsdkproject.databinding.FragmentMaintenanceactivitytypesDetailBinding;
...
import com.sap.cloud.mobile.odata.EntityKey;
/**
 * A fragment representing a single MaintenanceActivityType detail screen.
 * This fragment is contained in an MaintenanceActivityTypesActivity.
 */
public class MaintenanceActivityTypesDetailFragment extends InterfacedFragment<MaintenanceActivityType> {

    /** Generated data binding class based on layout file */
    private FragmentMaintenanceactivitytypesDetailBinding binding;

    /** MaintenanceActivityType entity to be displayed */
    private MaintenanceActivityType maintenanceActivityTypeEntity = null;
    ...
    /** Arguments: MaintenanceActivityType for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            maintenanceActivityTypeEntity = entity;
            binding.setMaintenanceActivityType(entity);
            setupObjectHeader();
        });
    }
    ...
    private void onDeleteComplete(@NonNull OperationResult<MaintenanceActivityType> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, maintenanceActivityTypeEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull MaintenanceActivityType maintenanceActivityTypeEntity) {
        viewModel.downloadMedia(maintenanceActivityTypeEntity, media -> {
            ...
            if (maintenanceActivityTypeEntity.getDataValue(MaintenanceActivityType.languageKey) != null && !maintenanceActivityTypeEntity.getDataValue(MaintenanceActivityType.languageKey).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(maintenanceActivityTypeEntity.getDataValue(MaintenanceActivityType.languageKey).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of MaintenanceActivityType
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(maintenanceActivityTypeEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(maintenanceActivityTypeEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(maintenanceActivityTypeEntity));
            ...
            setDetailImage(objectHeader, maintenanceActivityTypeEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentMaintenanceactivitytypesDetailBinding.inflate(inflater, container, false);
