 ...
 * - {@link CatalogTypesCreateFragment}: to create or edit a(n) CatalogType,
 * - {@link CatalogTypesDetailFragment}: to display the details of a(n) CatalogType,
 * - {@link CatalogTypesListFragment}: to list CatalogTypes.
 *
 ...
 * what to do.
 */
public class CatalogTypesActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CatalogType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CatalogTypesListFragment} is
     * getting instantiated (which will load {@link CatalogTypesDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CatalogTypesListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable CatalogType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CatalogTypesCreateFragment fragment = new CatalogTypesCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CatalogType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CatalogTypesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CatalogTypesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CatalogType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CatalogTypesCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CatalogTypesActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CatalogTypeViewModel viewModel = ViewModelProviders.of(getActivity()).get(CatalogTypeViewModel.class);
