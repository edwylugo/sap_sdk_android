 ...
 * - {@link CatalogTypeBatchssCreateFragment}: to create or edit a(n) CatalogTypeBatchs,
 * - {@link CatalogTypeBatchssDetailFragment}: to display the details of a(n) CatalogTypeBatchs,
 * - {@link CatalogTypeBatchssListFragment}: to list CatalogTypeBatchss.
 *
 ...
 * what to do.
 */
public class CatalogTypeBatchssActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CatalogTypeBatchs> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CatalogTypeBatchssListFragment} is
     * getting instantiated (which will load {@link CatalogTypeBatchssDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CatalogTypeBatchssListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable CatalogTypeBatchs entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CatalogTypeBatchssCreateFragment fragment = new CatalogTypeBatchssCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CatalogTypeBatchs entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CatalogTypeBatchssDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CatalogTypeBatchssDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CatalogTypeBatchs entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CatalogTypeBatchssCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CatalogTypeBatchssActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CatalogTypeBatchsViewModel viewModel = ViewModelProviders.of(getActivity()).get(CatalogTypeBatchsViewModel.class);
