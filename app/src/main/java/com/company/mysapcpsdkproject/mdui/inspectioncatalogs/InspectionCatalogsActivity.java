 ...
 * - {@link InspectionCatalogsCreateFragment}: to create or edit a(n) InspectionCatalog,
 * - {@link InspectionCatalogsDetailFragment}: to display the details of a(n) InspectionCatalog,
 * - {@link InspectionCatalogsListFragment}: to list InspectionCatalogs.
 *
 ...
 * what to do.
 */
public class InspectionCatalogsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<InspectionCatalog> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link InspectionCatalogsListFragment} is
     * getting instantiated (which will load {@link InspectionCatalogsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new InspectionCatalogsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable InspectionCatalog entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        InspectionCatalogsCreateFragment fragment = new InspectionCatalogsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable InspectionCatalog entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new InspectionCatalogsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new InspectionCatalogsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable InspectionCatalog entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link InspectionCatalogsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((InspectionCatalogsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            InspectionCatalogViewModel viewModel = ViewModelProviders.of(getActivity()).get(InspectionCatalogViewModel.class);
