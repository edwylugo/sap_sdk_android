 ...
 * - {@link ParameterssCreateFragment}: to create or edit a(n) Parameters,
 * - {@link ParameterssDetailFragment}: to display the details of a(n) Parameters,
 * - {@link ParameterssListFragment}: to list Parameterss.
 *
 ...
 * what to do.
 */
public class ParameterssActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Parameters> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ParameterssListFragment} is
     * getting instantiated (which will load {@link ParameterssDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ParameterssListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Parameters entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ParameterssCreateFragment fragment = new ParameterssCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Parameters entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ParameterssDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ParameterssDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Parameters entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ParameterssCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ParameterssActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ParametersViewModel viewModel = ViewModelProviders.of(getActivity()).get(ParametersViewModel.class);
