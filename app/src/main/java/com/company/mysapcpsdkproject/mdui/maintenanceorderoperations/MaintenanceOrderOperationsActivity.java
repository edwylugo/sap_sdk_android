 ...
 * - {@link MaintenanceOrderOperationsCreateFragment}: to create or edit a(n) MaintenanceOrderOperation,
 * - {@link MaintenanceOrderOperationsDetailFragment}: to display the details of a(n) MaintenanceOrderOperation,
 * - {@link MaintenanceOrderOperationsListFragment}: to list MaintenanceOrderOperations.
 *
 ...
 * what to do.
 */
public class MaintenanceOrderOperationsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceOrderOperation> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceOrderOperationsListFragment} is
     * getting instantiated (which will load {@link MaintenanceOrderOperationsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrderOperationsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceOrderOperation entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceOrderOperationsCreateFragment fragment = new MaintenanceOrderOperationsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceOrderOperation entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrderOperationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceOrderOperationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceOrderOperation entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceOrderOperationsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceOrderOperationsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceOrderOperationViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceOrderOperationViewModel.class);
