 ...
 * - {@link LogSapsCreateFragment}: to create or edit a(n) LogSap,
 * - {@link LogSapsDetailFragment}: to display the details of a(n) LogSap,
 * - {@link LogSapsListFragment}: to list LogSaps.
 *
 ...
 * what to do.
 */
public class LogSapsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<LogSap> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link LogSapsListFragment} is
     * getting instantiated (which will load {@link LogSapsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LogSapsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable LogSap entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        LogSapsCreateFragment fragment = new LogSapsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable LogSap entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LogSapsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new LogSapsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable LogSap entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link LogSapsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((LogSapsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            LogSapViewModel viewModel = ViewModelProviders.of(getActivity()).get(LogSapViewModel.class);
