...
import com.company.mysapcpsdkproject.databinding.FragmentMaterialdescriptionsDetailBinding;
...
import com.sap.cloud.mobile.odata.EntityKey;
/**
 * A fragment representing a single MaterialDescription detail screen.
 * This fragment is contained in an MaterialDescriptionsActivity.
 */
public class MaterialDescriptionsDetailFragment extends InterfacedFragment<MaterialDescription> {

    /** Generated data binding class based on layout file */
    private FragmentMaterialdescriptionsDetailBinding binding;

    /** MaterialDescription entity to be displayed */
    private MaterialDescription materialDescriptionEntity = null;
    ...
    /** Arguments: MaterialDescription for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            materialDescriptionEntity = entity;
            binding.setMaterialDescription(entity);
            setupObjectHeader();
        });
    }
    ...
    private void onDeleteComplete(@NonNull OperationResult<MaterialDescription> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, materialDescriptionEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull MaterialDescription materialDescriptionEntity) {
        viewModel.downloadMedia(materialDescriptionEntity, media -> {
            ...
            if (materialDescriptionEntity.getDataValue(MaterialDescription.baseUnitMeasure) != null && !materialDescriptionEntity.getDataValue(MaterialDescription.baseUnitMeasure).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(materialDescriptionEntity.getDataValue(MaterialDescription.baseUnitMeasure).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of MaterialDescription
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(materialDescriptionEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(materialDescriptionEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(materialDescriptionEntity));
            ...
            setDetailImage(objectHeader, materialDescriptionEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentMaterialdescriptionsDetailBinding.inflate(inflater, container, false);
