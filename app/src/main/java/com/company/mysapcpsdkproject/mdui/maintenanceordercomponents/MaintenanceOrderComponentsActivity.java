 ...
 * - {@link MaintenanceOrderComponentsCreateFragment}: to create or edit a(n) MaintenanceOrderComponent,
 * - {@link MaintenanceOrderComponentsDetailFragment}: to display the details of a(n) MaintenanceOrderComponent,
 * - {@link MaintenanceOrderComponentsListFragment}: to list MaintenanceOrderComponents.
 *
 ...
 * what to do.
 */
public class MaintenanceOrderComponentsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceOrderComponent> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceOrderComponentsListFragment} is
     * getting instantiated (which will load {@link MaintenanceOrderComponentsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrderComponentsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceOrderComponent entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceOrderComponentsCreateFragment fragment = new MaintenanceOrderComponentsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceOrderComponent entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrderComponentsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceOrderComponentsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceOrderComponent entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceOrderComponentsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceOrderComponentsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceOrderComponentViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceOrderComponentViewModel.class);
