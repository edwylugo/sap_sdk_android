 ...
 * - {@link CauseOfConfirmationsCreateFragment}: to create or edit a(n) CauseOfConfirmation,
 * - {@link CauseOfConfirmationsDetailFragment}: to display the details of a(n) CauseOfConfirmation,
 * - {@link CauseOfConfirmationsListFragment}: to list CauseOfConfirmations.
 *
 ...
 * what to do.
 */
public class CauseOfConfirmationsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CauseOfConfirmation> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CauseOfConfirmationsListFragment} is
     * getting instantiated (which will load {@link CauseOfConfirmationsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CauseOfConfirmationsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable CauseOfConfirmation entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CauseOfConfirmationsCreateFragment fragment = new CauseOfConfirmationsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CauseOfConfirmation entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CauseOfConfirmationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CauseOfConfirmationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CauseOfConfirmation entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CauseOfConfirmationsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CauseOfConfirmationsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CauseOfConfirmationViewModel viewModel = ViewModelProviders.of(getActivity()).get(CauseOfConfirmationViewModel.class);
