 ...
 * - {@link MaintenanceNotificationItemsCreateFragment}: to create or edit a(n) MaintenanceNotificationItem,
 * - {@link MaintenanceNotificationItemsDetailFragment}: to display the details of a(n) MaintenanceNotificationItem,
 * - {@link MaintenanceNotificationItemsListFragment}: to list MaintenanceNotificationItems.
 *
 ...
 * what to do.
 */
public class MaintenanceNotificationItemsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceNotificationItem> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceNotificationItemsListFragment} is
     * getting instantiated (which will load {@link MaintenanceNotificationItemsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceNotificationItemsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceNotificationItem entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceNotificationItemsCreateFragment fragment = new MaintenanceNotificationItemsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceNotificationItem entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceNotificationItemsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceNotificationItemsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceNotificationItem entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceNotificationItemsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceNotificationItemsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceNotificationItemViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceNotificationItemViewModel.class);
