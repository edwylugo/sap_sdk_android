 ...
 * - {@link ConfigDataBatchsCreateFragment}: to create or edit a(n) ConfigDataBatch,
 * - {@link ConfigDataBatchsDetailFragment}: to display the details of a(n) ConfigDataBatch,
 * - {@link ConfigDataBatchsListFragment}: to list ConfigDataBatchs.
 *
 ...
 * what to do.
 */
public class ConfigDataBatchsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ConfigDataBatch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ConfigDataBatchsListFragment} is
     * getting instantiated (which will load {@link ConfigDataBatchsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ConfigDataBatchsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ConfigDataBatch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ConfigDataBatchsCreateFragment fragment = new ConfigDataBatchsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ConfigDataBatch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ConfigDataBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ConfigDataBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ConfigDataBatch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ConfigDataBatchsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ConfigDataBatchsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ConfigDataBatchViewModel viewModel = ViewModelProviders.of(getActivity()).get(ConfigDataBatchViewModel.class);
