 ...
 * - {@link OrderTypeTextsCreateFragment}: to create or edit a(n) OrderTypeText,
 * - {@link OrderTypeTextsDetailFragment}: to display the details of a(n) OrderTypeText,
 * - {@link OrderTypeTextsListFragment}: to list OrderTypeTexts.
 *
 ...
 * what to do.
 */
public class OrderTypeTextsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<OrderTypeText> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link OrderTypeTextsListFragment} is
     * getting instantiated (which will load {@link OrderTypeTextsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderTypeTextsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable OrderTypeText entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        OrderTypeTextsCreateFragment fragment = new OrderTypeTextsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable OrderTypeText entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OrderTypeTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new OrderTypeTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable OrderTypeText entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link OrderTypeTextsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((OrderTypeTextsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            OrderTypeTextViewModel viewModel = ViewModelProviders.of(getActivity()).get(OrderTypeTextViewModel.class);
