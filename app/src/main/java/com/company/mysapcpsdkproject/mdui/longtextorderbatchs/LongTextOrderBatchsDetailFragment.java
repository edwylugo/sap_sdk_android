...
import com.company.mysapcpsdkproject.databinding.FragmentLongtextorderbatchsDetailBinding;
...
/**
 * A fragment representing a single LongTextOrderBatch detail screen.
 * This fragment is contained in an LongTextOrderBatchsActivity.
 */
public class LongTextOrderBatchsDetailFragment extends InterfacedFragment<LongTextOrderBatch> {

    /** Generated data binding class based on layout file */
    private FragmentLongtextorderbatchsDetailBinding binding;

    /** LongTextOrderBatch entity to be displayed */
    private LongTextOrderBatch longTextOrderBatchEntity = null;
    ...
    /** Arguments: LongTextOrderBatch for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            longTextOrderBatchEntity = entity;
            binding.setLongTextOrderBatch(entity);
            setupObjectHeader();
        });
    }
    ...
    public void onNavigationClickedToLongTextOrders_LongTextOrderDetails(View v) {
        ...
        intent.putExtra("parent", longTextOrderBatchEntity);
    ...
    private void onDeleteComplete(@NonNull OperationResult<LongTextOrderBatch> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, longTextOrderBatchEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull LongTextOrderBatch longTextOrderBatchEntity) {
        viewModel.downloadMedia(longTextOrderBatchEntity, media -> {
            ...
            if (longTextOrderBatchEntity.getDataValue(LongTextOrderBatch.id) != null && !longTextOrderBatchEntity.getDataValue(LongTextOrderBatch.id).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(longTextOrderBatchEntity.getDataValue(LongTextOrderBatch.id).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of LongTextOrderBatch
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(longTextOrderBatchEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(longTextOrderBatchEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(longTextOrderBatchEntity));
            ...
            setDetailImage(objectHeader, longTextOrderBatchEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentLongtextorderbatchsDetailBinding.inflate(inflater, container, false);
