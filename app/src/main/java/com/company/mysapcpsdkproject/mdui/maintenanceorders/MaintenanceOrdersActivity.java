 ...
 * - {@link MaintenanceOrdersCreateFragment}: to create or edit a(n) MaintenanceOrder,
 * - {@link MaintenanceOrdersDetailFragment}: to display the details of a(n) MaintenanceOrder,
 * - {@link MaintenanceOrdersListFragment}: to list MaintenanceOrders.
 *
 ...
 * what to do.
 */
public class MaintenanceOrdersActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceOrder> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceOrdersListFragment} is
     * getting instantiated (which will load {@link MaintenanceOrdersDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrdersListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceOrder entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceOrdersCreateFragment fragment = new MaintenanceOrdersCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceOrder entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrdersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceOrdersDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceOrder entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceOrdersCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceOrdersActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceOrderViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceOrderViewModel.class);
