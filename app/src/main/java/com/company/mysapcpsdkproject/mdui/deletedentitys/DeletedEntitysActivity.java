 ...
 * - {@link DeletedEntitysCreateFragment}: to create or edit a(n) DeletedEntity,
 * - {@link DeletedEntitysDetailFragment}: to display the details of a(n) DeletedEntity,
 * - {@link DeletedEntitysListFragment}: to list DeletedEntitys.
 *
 ...
 * what to do.
 */
public class DeletedEntitysActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<DeletedEntity> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link DeletedEntitysListFragment} is
     * getting instantiated (which will load {@link DeletedEntitysDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DeletedEntitysListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable DeletedEntity entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        DeletedEntitysCreateFragment fragment = new DeletedEntitysCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable DeletedEntity entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DeletedEntitysDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new DeletedEntitysDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable DeletedEntity entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link DeletedEntitysCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((DeletedEntitysActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            DeletedEntityViewModel viewModel = ViewModelProviders.of(getActivity()).get(DeletedEntityViewModel.class);
