 ...
 * - {@link LongTextNotificationsCreateFragment}: to create or edit a(n) LongTextNotification,
 * - {@link LongTextNotificationsDetailFragment}: to display the details of a(n) LongTextNotification,
 * - {@link LongTextNotificationsListFragment}: to list LongTextNotifications.
 *
 ...
 * what to do.
 */
public class LongTextNotificationsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<LongTextNotification> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link LongTextNotificationsListFragment} is
     * getting instantiated (which will load {@link LongTextNotificationsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextNotificationsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable LongTextNotification entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        LongTextNotificationsCreateFragment fragment = new LongTextNotificationsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable LongTextNotification entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextNotificationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new LongTextNotificationsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable LongTextNotification entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link LongTextNotificationsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((LongTextNotificationsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            LongTextNotificationViewModel viewModel = ViewModelProviders.of(getActivity()).get(LongTextNotificationViewModel.class);
