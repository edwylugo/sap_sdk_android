...
import com.company.mysapcpsdkproject.databinding.FragmentLongtextnotificationbatchsDetailBinding;
...
/**
 * A fragment representing a single LongTextNotificationBatch detail screen.
 * This fragment is contained in an LongTextNotificationBatchsActivity.
 */
public class LongTextNotificationBatchsDetailFragment extends InterfacedFragment<LongTextNotificationBatch> {

    /** Generated data binding class based on layout file */
    private FragmentLongtextnotificationbatchsDetailBinding binding;

    /** LongTextNotificationBatch entity to be displayed */
    private LongTextNotificationBatch longTextNotificationBatchEntity = null;
    ...
    /** Arguments: LongTextNotificationBatch for display */
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSelectedEntity().observe(this, entity -> {
            longTextNotificationBatchEntity = entity;
            binding.setLongTextNotificationBatch(entity);
            setupObjectHeader();
        });
    }
    ...
    public void onNavigationClickedToLongTextNotifications_LongTextNotificationDetails(View v) {
        ...
        intent.putExtra("parent", longTextNotificationBatchEntity);
    ...
    private void onDeleteComplete(@NonNull OperationResult<LongTextNotificationBatch> result) {
        ...
        listener.onFragmentStateChange(UIConstants.EVENT_DELETION_COMPLETED, longTextNotificationBatchEntity);
    }
     ...
     */
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull LongTextNotificationBatch longTextNotificationBatchEntity) {
        viewModel.downloadMedia(longTextNotificationBatchEntity, media -> {
            ...
            if (longTextNotificationBatchEntity.getDataValue(LongTextNotificationBatch.id) != null && !longTextNotificationBatchEntity.getDataValue(LongTextNotificationBatch.id).toString().isEmpty()) {
                objectHeader.setDetailImageCharacter(longTextNotificationBatchEntity.getDataValue(LongTextNotificationBatch.id).toString().substring(0, 1));
            } else {
    ...
    /**
     * Setup ObjectHeader with an instance of LongTextNotificationBatch
     */
    private void setupObjectHeader() {
        Toolbar secondToolbar = currentActivity.findViewById(R.id.secondaryToolbar);
        if (secondToolbar != null) {
            secondToolbar.setTitle(longTextNotificationBatchEntity.getEntityType().getLocalName());
        } else {
            currentActivity.setTitle(longTextNotificationBatchEntity.getEntityType().getLocalName());
        }
        ...
        if (objectHeader != null) {
            ...
            objectHeader.setSubheadline(EntityKeyUtil.getOptionalEntityKey(longTextNotificationBatchEntity));
            ...
            setDetailImage(objectHeader, longTextNotificationBatchEntity);
    ...
    private View setupDataBinding(LayoutInflater inflater, ViewGroup container) {
        binding = FragmentLongtextnotificationbatchsDetailBinding.inflate(inflater, container, false);
