 ...
 * - {@link PriorityTextsCreateFragment}: to create or edit a(n) PriorityText,
 * - {@link PriorityTextsDetailFragment}: to display the details of a(n) PriorityText,
 * - {@link PriorityTextsListFragment}: to list PriorityTexts.
 *
 ...
 * what to do.
 */
public class PriorityTextsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PriorityText> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PriorityTextsListFragment} is
     * getting instantiated (which will load {@link PriorityTextsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PriorityTextsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PriorityText entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PriorityTextsCreateFragment fragment = new PriorityTextsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PriorityText entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PriorityTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PriorityTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PriorityText entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PriorityTextsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PriorityTextsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PriorityTextViewModel viewModel = ViewModelProviders.of(getActivity()).get(PriorityTextViewModel.class);
