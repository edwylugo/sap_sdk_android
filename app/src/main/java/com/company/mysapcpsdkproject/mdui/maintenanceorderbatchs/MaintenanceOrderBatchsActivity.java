 ...
 * - {@link MaintenanceOrderBatchsCreateFragment}: to create or edit a(n) MaintenanceOrderBatch,
 * - {@link MaintenanceOrderBatchsDetailFragment}: to display the details of a(n) MaintenanceOrderBatch,
 * - {@link MaintenanceOrderBatchsListFragment}: to list MaintenanceOrderBatchs.
 *
 ...
 * what to do.
 */
public class MaintenanceOrderBatchsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MaintenanceOrderBatch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MaintenanceOrderBatchsListFragment} is
     * getting instantiated (which will load {@link MaintenanceOrderBatchsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrderBatchsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MaintenanceOrderBatch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MaintenanceOrderBatchsCreateFragment fragment = new MaintenanceOrderBatchsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MaintenanceOrderBatch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MaintenanceOrderBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MaintenanceOrderBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MaintenanceOrderBatch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MaintenanceOrderBatchsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MaintenanceOrderBatchsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MaintenanceOrderBatchViewModel viewModel = ViewModelProviders.of(getActivity()).get(MaintenanceOrderBatchViewModel.class);
