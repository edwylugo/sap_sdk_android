 ...
 * - {@link ConfirmationTextsCreateFragment}: to create or edit a(n) ConfirmationText,
 * - {@link ConfirmationTextsDetailFragment}: to display the details of a(n) ConfirmationText,
 * - {@link ConfirmationTextsListFragment}: to list ConfirmationTexts.
 *
 ...
 * what to do.
 */
public class ConfirmationTextsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ConfirmationText> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ConfirmationTextsListFragment} is
     * getting instantiated (which will load {@link ConfirmationTextsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ConfirmationTextsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ConfirmationText entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ConfirmationTextsCreateFragment fragment = new ConfirmationTextsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ConfirmationText entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ConfirmationTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ConfirmationTextsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ConfirmationText entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ConfirmationTextsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ConfirmationTextsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ConfirmationTextViewModel viewModel = ViewModelProviders.of(getActivity()).get(ConfirmationTextViewModel.class);
