 ...
 * - {@link EmployeesCreateFragment}: to create or edit a(n) Employee,
 * - {@link EmployeesDetailFragment}: to display the details of a(n) Employee,
 * - {@link EmployeesListFragment}: to list Employees.
 *
 ...
 * what to do.
 */
public class EmployeesActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Employee> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link EmployeesListFragment} is
     * getting instantiated (which will load {@link EmployeesDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EmployeesListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Employee entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        EmployeesCreateFragment fragment = new EmployeesCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Employee entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new EmployeesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new EmployeesDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Employee entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link EmployeesCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((EmployeesActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            EmployeeViewModel viewModel = ViewModelProviders.of(getActivity()).get(EmployeeViewModel.class);
