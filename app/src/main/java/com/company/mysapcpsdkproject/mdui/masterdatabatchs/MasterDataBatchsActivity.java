 ...
 * - {@link MasterDataBatchsCreateFragment}: to create or edit a(n) MasterDataBatch,
 * - {@link MasterDataBatchsDetailFragment}: to display the details of a(n) MasterDataBatch,
 * - {@link MasterDataBatchsListFragment}: to list MasterDataBatchs.
 *
 ...
 * what to do.
 */
public class MasterDataBatchsActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MasterDataBatch> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MasterDataBatchsListFragment} is
     * getting instantiated (which will load {@link MasterDataBatchsDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MasterDataBatchsListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MasterDataBatch entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MasterDataBatchsCreateFragment fragment = new MasterDataBatchsCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MasterDataBatch entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MasterDataBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MasterDataBatchsDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MasterDataBatch entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MasterDataBatchsCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MasterDataBatchsActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MasterDataBatchViewModel viewModel = ViewModelProviders.of(getActivity()).get(MasterDataBatchViewModel.class);
