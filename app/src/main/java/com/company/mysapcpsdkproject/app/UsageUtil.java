...
import static com.company.mysapcpsdkproject.app.SAPWizardApplication.APPLICATION_VERSION;
...
public class UsageUtil {
    ...
    public void initUsage() throws OpenFailureException, EncryptionError, MalformedURLException {
        if (!UsageBroker.isStarted()) {
            ...
            UsageBroker.configure(application.getApplicationContext(), UUID.fromString("a21b2f0b-78a9-4d0f-bc86-0232ebba0487"));
        }
